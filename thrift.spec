...
Source0  : https://github.com/apache/thrift/archive/refs/tags/v0.16.0.tar.gz
...
%prep
%setup -q -n thrift-0.16.0
cd %{_builddir}/thrift-0.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648507780
...
cp %{_builddir}/thrift-0.16.0/LICENSE %{buildroot}/usr/share/package-licenses/thrift/104c027505ef428a77fdbaa2e3713b52c8d3cfc4
cp %{_builddir}/thrift-0.16.0/contrib/fb303/LICENSE %{buildroot}/usr/share/package-licenses/thrift/0d359463862b027340624ba0f1e357a316d04931
cp %{_builddir}/thrift-0.16.0/debian/copyright %{buildroot}/usr/share/package-licenses/thrift/da322783caa0f9315473bc22aa25dbb2ee422d2e
cp %{_builddir}/thrift-0.16.0/doc/licenses/otp-base-license.txt %{buildroot}/usr/share/package-licenses/thrift/ba013932d429012281592d6851de646407c757bf
cp %{_builddir}/thrift-0.16.0/lib/dart/LICENSE %{buildroot}/usr/share/package-licenses/thrift/0d359463862b027340624ba0f1e357a316d04931
%make_install
...
/usr/lib64/libthrift-0.16.0.so
/usr/lib64/libthrift.so
/usr/lib64/libthrift_c_glib.so
/usr/lib64/libthriftqt5-0.16.0.so
/usr/lib64/libthriftqt5.so
/usr/lib64/libthriftz-0.16.0.so
