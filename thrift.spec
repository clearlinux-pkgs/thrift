...
#
# Source0 file verified with key 0xC6F2B11BEDD02683 (jking@apache.org)
#
Name     : thrift
Version  : 0.12.0
Release  : 29
...
export LANG=C
export SOURCE_DATE_EPOCH=1559683873
...
cp LICENSE %{buildroot}/usr/share/package-licenses/thrift/LICENSE
cp lib/hs/LICENSE %{buildroot}/usr/share/package-licenses/thrift/lib_hs_LICENSE
cp tutorial/hs/LICENSE %{buildroot}/usr/share/package-licenses/thrift/tutorial_hs_LICENSE
%make_install
...
/usr/include/thrift/concurrency/StdMonitor.cpp
/usr/include/thrift/concurrency/StdMutex.cpp
/usr/include/thrift/concurrency/StdThreadFactory.cpp
/usr/include/thrift/concurrency/StdThreadFactory.h
...
/usr/lib64/libthrift-0.12.0.so
/usr/lib64/libthrift.so
/usr/lib64/libthrift_c_glib.so
/usr/lib64/libthriftqt5-0.12.0.so
/usr/lib64/libthriftqt5.so
/usr/lib64/libthriftz-0.12.0.so
...
/usr/share/package-licenses/thrift/LICENSE
/usr/share/package-licenses/thrift/lib_hs_LICENSE
/usr/share/package-licenses/thrift/tutorial_hs_LICENSE
